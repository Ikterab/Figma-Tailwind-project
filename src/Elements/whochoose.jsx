...
export function Offers() {
  return (
    <>
      <div
        className='main'
        class='flex justify-center 2xl:gap-40 xl:gap-0 w-full items-center font-[Poppins]'
      >
        <img src={audigari} class='2xl:w-full xl:w-[800px] lg:w-[600px]' />
        <div className='flex flex-col gap-7'>
          <h3 class='text-[15px] text-[#1572D3] bg-[#ECF5FF] h-[42px] w-[182px] pt- px-6.5 py-3 text-start  font-medium '>
            WHY CHOOSE US
          </h3>
          <h1 class='2xl:text-[38px] xl:text-[30px] lg:text-[28px]  font-medium text-start '>
            We offer the best experience with our rental deals
          </h1>
          {offers.map((offers, index) => (
            <div key={index} className='flex gap-5'>
              <div class='2xl:h-[75px] 2xl:w-[75px] xl:h-[70px] xl:w-[75px] lg:w-[65px] lg:h-[60px] bg-[#ECF5FF] 2xl:py-5 xl:py-5 2xl:px-5 xl:px-4 lg:px-2 lg:py-2 rounded-[16px] '>
