        ...
        <div className='flex flex-col items-center font-[Poppins] w-full mt-10'>
          ...
          >
            {rental.map((cars, index) => (
              <div
                key={index}
                class='        h-[450px]  sm:h-[405px] flex-wrap w-[356px] flex  sm:flex-nowrap sm:w-[256px] flex-col gap-1 bg-white rounded-[9px] shadow-[0_12px_24px_rgb(19,24,104,0.2)]'
              >
                <img
                  src={cars.img0}
                ...
                <div class='flex gap-3  px-15 sm:px-5 py-1'>
                  <img src={cars.img1} />
                  <div class='flex gap-1'>
                    <h3 class=' sm:text-[13px] text-[15px] font-medium'>
                      {cars.rate}
                    </h3>
                    <h3 class='whitespace-nowrap text-[#959595]   text-[15px] sm:text-[12px]'>
                      {cars.review}
                    </h3>
                  </div>
                </div>

                <div class='flex flex-wrap m-auto justify-center  gap-1 sm:gap-0 sm:justify-between sm:px-5 sm:py-1 '>
                  <div className='flex justify-between gap-13 '>
                    <div class='flex gap-1 py-1'>
                      <img src={cars?.specification?.img2?.[0]} />
                      <p class=' text-[15px] sm:text-[12px] text-[#959595] font-normal whitespace-nowrap'>
                ...
                <div class='flex justify-between px-10 py-3 sm:px-1 mt-2 sm:py-4 border-1 border-b-0 border-x-0 sm:w-[208px] ml-6 border-[#E0E0E0]'>
                ...
                <button class='flex gap-1 sm:ml-5 m-auto   px-14 bg-[#1572D3] items-center w-[208px] h-[40px] rounded-[8px] text-[14px] text-white cursor-pointer'>
                  Rent now <img src={whitearrow} />
                </button>
              </div>
            ))}
          </div>
          <button class='flex gap-1 mt-5 cursor-pointer 2xl:mt-20 xl:mt-10 lg:mt-10 md:mt-10 sm:mt-10 bg-white w-[210px] h-[48px] rounded-[8px] text-[14px] font-medium text-[#959595] border-[#E0E0E0] hover:bg-[#E0E0E0] border-1  py-3 px-8'>
