      ...
      <>
        <div className='font-[Poppins]'>
          <div className="  w-full bg-[url('/carsimg/HeroimgOfDetails.jpg')] bg-center bg-no-repeat bg-cover  h-[700px]">
            <h1 className='text-blue-50 text-start px-25 py-10 text-[45px] font-semibold '>
              Get details of your choosen car
            </h1>
          </div>

          <div className='flex  gap-10 2xl:px-20 px-10 mt-6'>
            <div>
              <img
                src={cars.img0}
                alt={cars.name}
                className='w-[500px] max-w-[500px] px-10 py-20 shadow-[1px_2px_19px_rgb(0,0,0,0.1)] hover:scale-106 transition-transform  rounded-sm '
            ...
            {zoom && (
              ...
              >
                <img
                  ...
                  className={`w-[90%] h-[100%]  bg-white shadow-[1px_2px_19px_rgb(0,0,0,0.1)] px-30  py-30 rounded-sm  `}
                  // style={{transform:`translate(${position.x}px, ${position.y}px) scale(${scale}) `}}
                />
              </div>
            )}
            <div className='text-start flex flex-col gap-2'>
              <h1 className='text-[45px]'>{cars.Name}</h1>
              ...
              <button className='text-start w-[150px] text-white bg-[#1572D3] px-8 py-2 rounded-md '>
                <Link to='/RentcarAuth'>Rent now</Link>
              </button>
